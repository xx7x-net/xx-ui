...
```javascript
import Vue from 'vue'
import XxStep from 'xx-steps'
import 'xx-theme-chalk/dist/step.css'
...
```javascript
import Vue from 'vue'
import { XxSteps, XxStep } from 'xx-steps'

Vue.component('xx-steps', XxSteps)
Vue.component('xx-step', XxStep)
```
