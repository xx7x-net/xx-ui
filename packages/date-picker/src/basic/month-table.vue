<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="xx-month-table">
    <tbody>
    <tr v-for="(row, key) in rows" :key="key">
      <td :class="getCellStyle(cell)" v-for="(cell, key) in row" :key="key">
        <div>
          <a class="cell">{{ monthsData[months[cell.text]] }}</a>
        </div>
      </td>
    </tr>
    </tbody>
...
<script type="text/babel">
  import { isDate, range, getDayCountOfMonth, nextDate } from 'xxqx-ui/src/utils/date-util';
  import { hasClass } from 'xxqx-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'xxqx-ui/src/utils/util';
