<template>
  <table
    ...
    <tr>
      ...
      <th v-for="(week, key) in WEEKS" :key="key">{{ weeksData[week] }}</th>
    </tr>
    <tr
      class="xx-date-table__row"
...
<script>
  import { getFirstDayOfMonth, getDayCountOfMonth, getWeekNumber, getStartDateOfMonth, prevDate, nextDate, isDate, clearTime as _clearTime} from 'xxqx-ui/src/utils/date-util';
  import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } from 'xxqx-ui/src/utils/util';
