<template>
  <div class="xx-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <xx-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="xx-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="xx-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="xx-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="xx-time-spinner__arrow xx-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="xx-time-spinner__arrow xx-icon-arrow-down"></i>
        <ul class="xx-time-spinner__list" ref="hours">
          <li
            class="xx-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="xx-time-spinner__arrow xx-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="xx-time-spinner__arrow xx-icon-arrow-down"></i>
        <ul class="xx-time-spinner__list" ref="minutes">
          <li
            class="xx-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="xx-time-spinner__arrow xx-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="xx-time-spinner__arrow xx-icon-arrow-down"></i>
        <ul class="xx-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'xxqx-ui/src/utils/date-util';
  import ElScrollbar from 'xxqx-ui/packages/scrollbar';
  import RepeatClick from 'xxqx-ui/src/directives/repeat-click';
