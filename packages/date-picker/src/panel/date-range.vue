<template>
  <transition name="xx-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="xx-picker-panel xx-date-range-picker xx-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="xx-picker-panel__body-wrapper">
        <slot name="sidebar" class="xx-picker-panel__sidebar"></slot>
        <div class="xx-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="xx-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="xx-picker-panel__body">
          <div class="xx-date-range-picker__time-header" v-if="showTime">
            <span class="xx-date-range-picker__editors-wrap">
              <span class="xx-date-range-picker__time-picker-wrap">
                <xx-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  placeholder="开始日期"
                  class="xx-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="xx-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <xx-input
                  size="small"
                  class="xx-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="xx-icon-arrow-right"></span>
            <span class="xx-date-range-picker__editors-wrap is-right">
              <span class="xx-date-range-picker__time-picker-wrap">
                <xx-input
                  size="small"
                  class="xx-date-range-picker__editor"
              ...
              <span class="xx-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <xx-input
                  size="small"
                  class="xx-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="xx-picker-panel__content xx-date-range-picker__content is-left">
            <div class="xx-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="xx-picker-panel__icon-btn xx-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="xx-picker-panel__icon-btn xx-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="xx-picker-panel__icon-btn xx-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="xx-picker-panel__icon-btn xx-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="xx-picker-panel__content xx-date-range-picker__content is-right">
            <div class="xx-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="xx-picker-panel__footer" v-if="showTime">
        <xx-button
          size="mini"
          type="text"
          class="xx-picker-panel__link-btn"
          @click="handleClear">
          清空
        </xx-button>
        <xx-button
...
<script type="text/babel">
  import {
    ...
    extractDateFormat,
    extractTimeFormat
  } from 'xxqx-ui/src/utils/date-util';
  import Clickoutside from 'xxqx-ui/src/utils/clickoutside';
  ...
  export default {
    ...
    computed: {
      ...
      leftLabel() {
        return this.leftDate.getFullYear() + ' ' + '年' + ' ' + this.month[`month${ this.leftDate.getMonth() + 1 }`];
      },

      rightLabel() {
        return this.rightDate.getFullYear() + ' ' + '年' + ' ' + this.month[`month${ this.leftDate.getMonth() + 1 }`];
      },
    ...
    components: { TimePicker, DateTable, XxInput, XxButton }
  };
</script>
