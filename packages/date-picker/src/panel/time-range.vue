<template>
  <transition
    ...
    <div
      v-show="visible"
      class="xx-time-range-picker xx-picker-panel xx-popper"
      :class="popperClass">
      <div class="xx-time-range-picker__content">
        <div class="xx-time-range-picker__cell">
          <div class="xx-time-range-picker__header">开始时间</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="xx-time-range-picker__body xx-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="xx-time-range-picker__cell">
          <div class="xx-time-range-picker__header">结束时间</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="xx-time-range-picker__body xx-time-panel__content">
            <time-spinner
      ...
      <div class="xx-time-panel__footer">
        <button
          type="button"
          class="xx-time-panel__btn cancel"
          @click="handleCancel()">取消</button>
        <button
          type="button"
          class="xx-time-panel__btn confirm"
          @click="handleConfirm()"
