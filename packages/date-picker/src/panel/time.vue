<template>
  <transition name="xx-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="xx-time-panel xx-popper"
      :class="popperClass">
      <div class="xx-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'xxqx-ui/src/utils/date-util';
