<template>
  <transition name="xx-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="xx-picker-panel xx-date-picker xx-popper"
      :class="[{
      ...
      <div class="xx-picker-panel__body-wrapper">
        ...
        <div class="xx-picker-panel__body">
          <div class="xx-date-picker__time-header" v-if="showTime">
            <span class="xx-date-picker__editor-wrap">
              <xx-input
                placeholder="选择日期"
                :value="visibleDate"
                size="small"
            ...
            <span class="xx-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <xx-input
                ref="input"
          ...
          <div
            class="xx-date-picker__header"
            :class="{ 'xx-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              aria-label="前一年"
              class="xx-picker-panel__icon-btn xx-date-picker__prev-btn xx-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              aria-label="上个月"
              class="xx-picker-panel__icon-btn xx-date-picker__prev-btn xx-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="xx-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="xx-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{ monthData[`month${ month + 1 }`] }}</span>
            <button
              type="button"
              @click="nextYear"
              aria-label="后一年"
              class="xx-picker-panel__icon-btn xx-date-picker__next-btn xx-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              v-show="currentView === 'date'"
              aria-label="下个月"
              class="xx-picker-panel__icon-btn xx-date-picker__next-btn xx-icon-arrow-right">
            </button>
          </div>

          <div class="xx-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, XxInput, XxButton
    },
