<template>
  <div
    class="xx-slider"
    :class="{ 'is-vertical': vertical, 'xx-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="xx-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="xx-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="xx-slider__stop xx-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="xx-slider__marks">
          <slider-marker
...
<script type="text/babel">
  import XxInputNumber from 'xxqx-ui/packages/input-number';
        ...
        if (this.range && Array.isArray(val)) {
          if (val[1] < this.min) {
            ...
            if (this.valueChanged()) {
              this.dispatch('XxFormItem', 'xx.form.change', [this.minValue, this.maxValue]);
