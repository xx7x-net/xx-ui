<script>
  import XxCollapseTransition from 'xxqx-ui/src/transitions/collapse-transition';
  ...
  export default {
    ...
    componentName: 'XxSubmenu',

    mixins: [menuMixin, Emitter, poperMixins],

    components: { XxCollapseTransition },
    ...
    computed: {
      ...
      menuTransitionName() {
        return this.rootMenu.collapse ? 'xx-zoom-in-left' : 'xx-zoom-in-top';
      },
      opened() {
      ...
      isFirstLevel() {
        ...
        while (parent && parent !== this.rootMenu) {
          if (['XxSubmenu', 'XxMenuItemGroup'].indexOf(parent.$options.componentName) > -1) {
            isFirstLevel = false;
            break;
          } else {
    ...
    render(h) {
      ...
      const popupMenu = (
        <transition name={menuTransitionName}>
          <div
            ref="menu"
            v-show={opened}
            class={[`xx-menu--${mode}`, popperClass]}
            ...
            <ul
              role="menu"
              class={['xx-menu xx-menu--popup', `xx-menu--popup-${currentPlacement}`]}
      ...
      ) ? 'xx-icon-arrow-down' : 'xx-icon-arrow-right';
      ...
      return (
        ...
        >
          ...
          >
            {$slots.title}
            <i class={[ 'xx-submenu__icon-arrow', submenuTitleIcon ]}></i>
          </div>
