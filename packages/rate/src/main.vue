    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="xx-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="xx-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'xxqx-ui/src/utils/dom';
  import { isObject } from 'xxqx-ui/src/utils/types';
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['xx-icon-star-on', 'xx-icon-star-on', 'xx-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'xx-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'xx-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'xx-rate__item')) {
            target = target.querySelector('.xx-rate__icon');
          }
          if (hasClass(target, 'xx-rate__decimal')) {
