<script>
  ...
  import ElRadio from 'xxqx-ui/packages/radio';
  import { isEqual } from 'xxqx-ui/src/utils/util';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="xx-icon-check xx-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="xx-icon-loading xx-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="xx-icon-arrow-right xx-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="xx-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
