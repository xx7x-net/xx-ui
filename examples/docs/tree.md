...
:::demo
```html
<xx-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></xx-tree>
...
<div class="buttons">
  <xx-button @click="getCheckedNodes">通过 node 获取</xx-button>
  <xx-button @click="getCheckedKeys">通过 key 获取</xx-button>
  <xx-button @click="setCheckedNodes">通过 node 设置</xx-button>
  <xx-button @click="setCheckedKeys">通过 key 设置</xx-button>
  <xx-button @click="resetChecked">清空</xx-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <xx-button size="mini" type="text" on-click={ () => this.append(data) }>Append</xx-button>
              <xx-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</xx-button>
            </span>
          </span>);
      }
    }
