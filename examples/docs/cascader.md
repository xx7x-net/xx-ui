...
<div class="block">
  ...
  <xx-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></xx-cascader>
</div>
<div class="block">
...
```html
<xx-cascader :options="options"></xx-cascader>
...
:::demo
```html
<xx-cascader :options="options" clearable></xx-cascader>
...
```html
<xx-cascader :options="options" :show-all-levels="false"></xx-cascader>
...
```html
<xx-cascader :props="props"></xx-cascader>
...
```html
<xx-cascader-panel :options="options"></xx-cascader-panel>
