...
```html
<template>
  <xx-transfer v-model="value" :data="data"></xx-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <xx-transfer
      ...
      @change="handleChange"
      :data="data">
      <xx-button class="transfer-footer" slot="left-footer" size="small">操作</xx-button>
      <xx-button class="transfer-footer" slot="right-footer" size="small">操作</xx-button>
    </xx-transfer>
  </div>
