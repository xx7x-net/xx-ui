...
<style lang="scss">
  ...
  .theme-picker .xx-color-picker__trigger {
    vertical-align: middle;
  }
  
  .theme-picker-dropdown .xx-color-dropdown__link-btn {
    display: none;
  }
</style>
  ...
  export default {
    ...
    watch: {
      theme(val, oldVal) {
        ...
        if (!this.chalk) {
          const url = `https://unpkg.com/xxqx-ui@${ version }/lib/theme-chalk/index.css`;
